...
import chatgptlogo2 from '@/assets/sm1.jpg'
import nouserlogo from '@/assets/sm3.png'
            ...
            <div className={styles.rightin}>
                            ...
                            {allMessages.map((msg, index) => (
                                <div key={index} className={styles.message}>
                                    ...
                                    <div className={styles.details}>
                                        <h2>{msg.role === 'user' ? 'You' : 'MyGPT Bot'}</h2>
                ...
                <div className={styles.bottomsection}>
                    <div className={styles.messagebar}>
                        <input type='text' placeholder='Message MyGPT Bot...'
                    ...
                    <p>MyGPT BOT can make mistakes. Consider checking important information.</p>
